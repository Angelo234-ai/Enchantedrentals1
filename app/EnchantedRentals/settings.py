"""
Django settings for EnchantedRentals project.
...
SECRET_KEY = ('DJANGO_SECRET_KEY',
              'django-insecure-m4e^tzk1ci+v)2l-l)d*8(6_m$9+a8^-n%hqqlbhq284op_!!*')
...
ROOT_URLCONF = 'EnchantedRentals.urls'
...
WSGI_APPLICATION = 'EnchantedRentals.wsgi.application'
